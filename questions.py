...
words_list = random.sample(
    categorias[eleccion],
    len(categorias[eleccion])
) #Arma una lista random de las palabras que se van usando

for word in words_list: #Comienzan las rondas
...
print("Se terminaron las palabras.")#Palabras agotadas